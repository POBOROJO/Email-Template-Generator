              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <h1 className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                    Modern Solutions for Email Communication
                  </h1>
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                    Generate professional emails, adjust tones, personalize cold
                    emails, and craft catchy subject lines effortlessly.
                  </p>
                </AnimatedGroup>
              ...
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1516382799247-87df95d790b7?q=80&w=2700&auto=format&fit=crop"
                    alt="app screen"
                    width="2700"
                    height="1440"
                  />
